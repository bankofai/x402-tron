...
from x402.abi import get_payment_permit_eip712_types, EIP712_DOMAIN_TYPE, PAYMENT_PERMIT_PRIMARY_TYPE
from x402.config import NetworkConfig
from x402.mechanisms.server.base import ServerMechanism
from x402.tokens import TokenRegistry
from x402.types import PaymentRequirements, PaymentRequirementsExtra, KIND_MAP
...
class BaseUptoServerMechanism(ServerMechanism):
    ...
    def _convert_permit_to_message(self, permit: Any) -> dict[str, Any]:
        ...
        """
        from x402.utils import payment_id_to_bytes
